...
### Backend Developer | Инженер с системным подходом

Я специализируюсь на **Python (FastAPI / asyncio)**. Мой бэкграунд в инженерных системах помогает мне писать надежный и оптимизированный код, понимая, как он работает на уровне системы и железа.

---

### 🛠 Стек и инструменты
* **Языки:** Python (FastAPI, SQLAlchemy, Pytest), базовый C/C++.
* **Инфраструктура:** Docker, Docker Compose, PostgreSQL, Redis, Linux (Bash).
* **AI:** Интеграция LLM (OpenAI API), работа с RAG-системами.
